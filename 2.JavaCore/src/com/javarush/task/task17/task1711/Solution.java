...
public class Solution {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        switch (args[0])
        {
            case "-c": synchronized (allPeople) {CreateC(args); break;}
            case "-u": synchronized (allPeople) {UpdateU(args); break;}
            case "-d": synchronized (allPeople) {DeleteD(args); break;}
            case "-i": synchronized (allPeople) {InfoI(args); break;}
        }
    }
